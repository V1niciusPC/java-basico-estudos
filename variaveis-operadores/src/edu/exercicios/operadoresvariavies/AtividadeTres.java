...
public class AtividadeTres {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("valor antes do incremento: "+ (++numero)); //valor alterado mostrado
        System.out.println("valor pos incremento: "+(numero++)); //valor mostrado e depois alterado
